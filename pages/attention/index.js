...
const style = {
  ...
  right:
    "w-[100%] md:w-[50%] bg-[#181818] h-[60vh] md:h-[100vh] text-stone-200 flex flex-col justify-center px-4 md:px-12",
};
      ...
      <div className={style.wrapper} style={{ fontFamily: "Inter,sans-serif" }}>
        ...
        <div className={style.right}>
          <div className="w-[95%] md:w-[60%]">
            ...
            <p className="my-3 text-stone-300 text-lg" style={{fontWeight:300}}>
