    ...
    <Animator>
      <div className="w-[90%] md:w-[44%] mx-auto">
        ...
        >
          ...
          birth, gender, current weight and height, target weight, fitness
        ...
        >
          ...
          by Amplitude, Facebook, Google, Twitter, Pinterest, Verizon Media. As
          a result, some of the data is stored and processed on servers of such
          third parties. This enables us to (1) analyze different interactions
          (how often users make subscriptions, the average weight and height of
          our users, how many users chose a particular area for improvement);
          (2) serve ads (and are able to show them only to a particular group of
          users, for example, to users who have already made a purchase).
          Consequently, we, in particular, better understand in what of our
          features and content you see the most value and are able to focus on
          them to enhance your experience and increase the quality of our
          products.
        </p>
        <p
          style={{ fontFamily: "Inter,sans-serif" }}
        ...
        >
          ...
          THIS PRIVACY POLICY FOR YOU). If you do not agree, or are unable to
          make this promise, you must not use the Service.
        </p>
      </div>
    </Animator>
  );
