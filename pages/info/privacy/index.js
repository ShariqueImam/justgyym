  ...
  return (
    <Animator>
      ...
      >
        ...
        problem areas, workouts, and food preferences, as well as answer certain
        lifestyle-related questions. We also automatically collect from your
        ...
        mobile carrier, hardware ID, Facebook ID, and other unique identifiers
        (such as IDFA and AAID). We need this data to provide our services,
        analyze how our customers use the service, to serve ads.
      </p>
      <p
        style={{ fontFamily: "Inter,sans-serif" }}
        className="text-gray-200 w-[90%] md:w-[45%] lg:w-[40%] mx-auto my-8"
      >
        ...
        Facebook, Google, Twitter, Pinterest, Verizon Media. As a result, some
        of the data is stored and processed on servers of such third parties.
        ...
        users who have already made a purchase). Consequently, we, in
      ...
      >
        ...
        (OR HAVE HAD YOUR PARENT OR GUARDIAN READ AND AGREE TO THIS PRIVACY
        POLICY FOR YOU). If you do not agree, or are unable to make this
        promise, you must not use the Service.
      </p>
    </Animator>
  );
};
