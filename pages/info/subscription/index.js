...
const style = {
  heading:
    "text-[#ffffff] mx-auto my-8 font-bold text-xl",
      ...
      <div className="w-[90%] md:w-[44%] mx-auto">
        <div style={{ fontFamily: "Inter,sans-serif" }}>
          ...
          <p className={style.para}>
            We may offer a free trial subscription for service. Unless you
            cancel at least 24 hours before the end of the free trial, you will
            be automatically charged a price indicated on the payment screen for
            a chosen subscription period.
          </p>
          ...
          <p className={style.para}>
            ...
            charge the applicable subscription fees to the payment method that
            you submit.
          </p>
          ...
          <p className={style.para}>
            ...
            features for the remaining time of your then-current period. Note
            that deleting the app does not cancel your subscriptions.
          </p>
          ...
          <p className={style.para}>
            If you purchased a subscription or enabled free trial on App Store:
            ...
            Apple support page Please take a screenshot of this information for
            your reference. This may help you to control your subscriptions.
          </p>
        </div>
      </div>
    </Animator>
