  ...
  return (
    <Animator>
      ...
      >
        ...
        Limited, a legal entity incorporated under the laws of the Republic of
        Cyprus, having its registered office at 1st Floor, Georgiou Christoforou
        8, 2012, Strovolos, Nicosia, Cyprus (“we” “us” “our” or the “Company”).
        The service delivered, the content, tools, transactions available by
        using the MadMuscles, are collectively referred to as the “Service”.
      </p>
      <h1
        style={{ fontFamily: "Inter,sans-serif" }}
        className="text-gray-200 w-[90%] md:w-[45%] lg:w-[40%] mx-auto my-8 font-bold text-xl"
      ...
      >
        ...
        LIMITATION, ANY COUNSELING, TESTING, EVALUATION, PRESCRIPTION, PROCEDURE
        OR THERAPY RELATED TO EXERCISE, NUTRITION, WEIGHT LOSS OR WELLNESS OR
        RELATED TO THE AVOIDANCE, PREVENTION, DIAGNOSIS OR TREATMENT OF ANY
        INJURY, ILLNESS, DISEASE OR CONDITION (COLLECTIVELY, “HEALTHCARE
        SERVICES”).
      </p>
    </Animator>
  );
