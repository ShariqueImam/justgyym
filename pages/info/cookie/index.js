    ...
    <Animator>
      <div style={{ fontFamily: "Inter,sans-serif" }}>
        ...
        <p className={style.para}>
          ...
          and why we use them. It also explains how you can control their use.
        </p>
        ...
        <p className={style.para}>
          ...
          between browser sessions and allow your preferences and actions across
          our website to be remembered.
        </p>
        <p className={style.para}>
        ...
        <p className={style.para}>
          ...
          platform that appears when you visit the website or when you click on
          the “Privacy” icon at the right bottom corner of any page of our
          website. It may be necessary to refresh the page for the updated
          settings to take effect. Essential cookies cannot be disabled, nor can
          the tool be used to block cookies on third-party websites linked to
          our website.
        </p>
        <p className={style.para}>
          ...
          about blocking and deleting cookies
        </p>
        <p className={style.para}>
          ...
          Advertising, the European Digital Advertising Alliance. To opt-out of
          interest-based advertising from the participating companies
        </p>
      </div>
    </Animator>
  );
