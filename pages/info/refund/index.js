      ...
      <div className="w-[90%] md:w-[44%] mx-auto">
        <div style={{ fontFamily: "Inter,sans-serif" }}>
          ...
          <p className={style.para}>
            ...
            made a purchase directly on our website and the money-back option
            was presented to you during the checkout, you are eligible to
            receive a refund provided that all of the following conditions are
            met.
          </p>

          <p className={style.para}>
            You contact us via email support@madmuscles.com within 30 days after
            your initial purchase and before the end of your subscription
            period; and
          </p>
          <h1 className={style.heading}>2. IMPORTANT DISCLAIMERS</h1>
          <p className={style.para}>
            You have followed the plan for at least 14 consecutive days within
          ...
          <p className={style.para}>
            Please note that only fulfillment of all the above requirements
            allows you to receive a full Voluntary Refund under “Money-back
            guarantee”. For the sake of clarity, this “Money-back guarantee”
            does not apply to the following cases:
          </p>
          <p className={style.para}>
            1. Personal reasons (you don’t like the product, it did not meet
