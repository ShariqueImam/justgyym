...
const style = {
  wrapper:
    "my-12 bg-neutral-900 border-2 border-stone-400 px-12 md:px-24 py-6 md:py-16 flex flex-col md:flex-row w-[95%] md:w-[80%] lg:w-[60%] mx-auto items-center",
  container: "flex flex-col my-6",
  heading: "text-gray-200 text-3xl md:text-4xl my-8 font-semibold",
  para: "text-stone-200 mr-12 text-lg",
};
const MoneyBack = () => {
  return (
    <div className={style.wrapper}>
      <div className={style.container}>
        ...
        <p className={style.para} style={{fontWeight:300}}>
          ...
          applicable limitations in our <Link href="/info/refund"><span className="text-orange-600">money-back </span></Link>policy
        </p>
      </div>
