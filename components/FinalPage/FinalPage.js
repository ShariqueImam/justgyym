...
const FinalPage = () => {
  ...
  return (
      <div className={style.wrapper} style={{ fontFamily: "Inter,sans-serif" }}>
        ...
        <Review fat={fat} />
        <Link href="#plan">
          <div  style={{ zIndex: 10 }} className="cursor-pointer hover:bg-orange-500 bg-[#ff4400] px-4 md:px-10 py-3 md:py-4 text-[#ffffff] font-bold fixed top-[90%] md:top-[87%] left-[25%] md:left-[42%] flex">
