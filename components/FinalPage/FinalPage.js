    ...
    <div className={style.wrapper} style={{ fontFamily: "Inter,sans-serif" }}>
      ...
      {scrollY < 1200 && (
        <Link href="#plan">
          <div
            style={{ zIndex: 10 }}
            className="fixed bottom-[0px] left-[0px] md:bottom-[0px] md:left-[42%] border-t-[2px] w-[100vw] md:w-auto md:border-none border-stone-700 bg-[#1e1e1e] md:bg-transparent cursor-pointer wtext-[#ffffff] font-bold flex  items-center"
          >
