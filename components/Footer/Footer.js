  ...
  return (
    <div className={style.wrapper}>
      <div className="mx-auto flex items-center justify-center flex-col">
        <h2 className="text-2xl md:text-4xl text-[#ffffff] font-semibold my-6">Follow Us</h2>
        <p className="text-md tracking-wide md:text-lg text-[#b3b3b3]" style={{fontWeight:300}}>to skyrocket your result!</p>
