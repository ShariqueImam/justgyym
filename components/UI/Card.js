...
export const StartCard = ({ cardText, imgUrl , isClick }) => {
    ...
    const cardStyle = {
      card: `${isClick ? ' border-orange-600':''} px-8 py-1 my-5 flex items-center justify-center bg-[#212121] hover:bg-[#313131] cursor-pointer transition duration-[10ms] hover:border-orange-700 border-2 border-transparent`,
