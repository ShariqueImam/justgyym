...
export const Card2 = ({ cardText,para, imgUrl ,isClick}) => {
  ...
  const cardStyle = {
    ...
    } mx-auto  px-8 py-3 my-5 flex items-center justify-center bg-[#212121] hover:bg-[#313131] cursor-pointer transition duration-[10ms] hover:border-orange-700 border-2 border-transparent`,
